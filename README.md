...
Back-end assignment for Sistemi Lab running on [Nest](https://github.com/nestjs/nest) framework TypeScript starter repository.
...
You will need Docker Desktop installed on your computer in order to run this app. Please refer to [Docker Desktop](https://www.docker.com/products/docker-desktop) for more information.
...
Save the .env file, then launch the DB image from a in detached mode with:
